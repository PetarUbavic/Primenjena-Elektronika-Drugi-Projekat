...
void initUART1(void)
{
    ...
    U1BRG=0x015; //ovim odredjujemo baudrate 0015
...
void pravo()
{
    ...
    PWM1(400);//malo samo povecao pwm da ide brze(400)
    PWM2(400);//malo samo povecao pwm da ide brze (400)
...
double OcitajLevo1()
{
  ...
  //WriteUART2dec2string(distanca1);
...
int main(int argc, char** argv) {
	...
	{ 
        ...
        //WriteUART2(13); 
        //RS232_putst2("RECENICA");
        /*for(broj1=0; broj1<100; broj1++)
            for(broj2=0; broj2<5000; broj2++);
            WriteUART2(13);*/
        ...
        {    
           // START:
            if (OcitajLevo1()<2500) // <1000
                pravo();

            else if (OcitajLevo1()>2500)  //>1000 //ocitaj levo je u stvari ocitaj desno
            {
                stani();
